...
class Swift_Mime_Headers_MailboxHeaderTest extends \SwiftMailerTestCase
{
    ...
    public function testTypeIsMailboxHeader()
    {
        ...
        self::assertEquals(Swift_Mime_Header::TYPE_MAILBOX, $header->getFieldType());
    }
    ...
    public function testMailboxIsSetForAddress()
    {
        ...
        self::assertEquals(array('chris@swiftmailer.org'), $header->getNameAddressStrings());
    }
    ...
    public function testMailboxIsRenderedForNameAddress()
    {
        ...
        self::assertEquals(array('Chris Corbyn <chris@swiftmailer.org>'), $header->getNameAddressStrings());
    }
    ...
    public function testAddressCanBeReturnedForAddress()
    {
        $header = $this->_getHeader('From', $this->_getEncoder('Q', true));
        $header->setAddresses('chris@swiftmailer.org');
        self::assertEquals(array('chris@swiftmailer.org'), $header->getAddresses());
    }
    ...
    public function testQuotesInNameAreQuoted()
    {
        ...
        self::assertEquals(array('"Chris Corbyn, \"DHE\"" <chris@swiftmailer.org>'), $header->getNameAddressStrings());
    }
    ...
    public function testGetMailboxesReturnsNameValuePairs()
    {
        $header = $this->_getHeader('From', $this->_getEncoder('Q', true));
        $header->setNameAddresses(array('chris@swiftmailer.org' => 'Chris Corbyn, DHE',));
        self::assertEquals(array('chris@swiftmailer.org' => 'Chris Corbyn, DHE'), $header->getNameAddresses());
    }
    ...
    public function testMultipleAddressesCanBeSetAndFetched()
    {
        ...
        self::assertEquals(array('chris@swiftmailer.org', 'mark@swiftmailer.org'), $header->getAddresses());
    }
    ...
    public function testMultipleAddressesAsMailboxStrings()
    {
        $header = $this->_getHeader('From', $this->_getEncoder('Q', true));
        $header->setAddresses(array('chris@swiftmailer.org', 'mark@swiftmailer.org',));
        self::assertEquals(array('chris@swiftmailer.org', 'mark@swiftmailer.org'), $header->getNameAddressStrings());
    }
    ...
    public function testRemoveAddressesWithSingleValue()
    {
        ...
        self::assertEquals(array('mark@swiftmailer.org'), $header->getAddresses());
    }
    ...
    public function testRemoveAddressesWithList()
    {
        ...
        self::assertEquals(array(), $header->getAddresses());
    }
    ...
    public function testSetBodyModel()
    {
        ...
        self::assertEquals(array('chris@swiftmailer.org' => null), $header->getNameAddresses());
    }
    ...
    public function testGetBodyModel()
    {
        ...
        self::assertEquals(array('chris@swiftmailer.org' => null), $header->getFieldBodyModel());
    }
